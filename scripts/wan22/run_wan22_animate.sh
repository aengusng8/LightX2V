...
video_path=/workspace/LightX2V/examples_video/wan_animate/animate/long_dancing.mp4
refer_path=/workspace/LightX2V/examples_video/wan_animate/animate/quang.jpg
use_flux=false

process_dir=${lightx2v_path}/save_results/animate/process_results_${use_flux}
...
[[ "$use_flux" == true ]] && preprocess_args+=(--use_flux)
python ${lightx2v_path}/tools/preprocess/preprocess_data.py "${preprocess_args[@]}"

# When use_flux, preprocess produces refer_edit.png; otherwise src_ref.png
...
echo "refer_path: $src_ref_images"
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_wan22_animate_${use_flux}.mp4
